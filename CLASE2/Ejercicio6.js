const objeto = {
    ...
    lineasDeDetalle : [
        {id : "001", article : "Cepillo",  quantity : 12, pedido : "A"},
        {id : "002", article : "Vasos",  quantity : 102, pedido : "A"},
        {id : "003", article : "Microfono",  quantity : 20, pedido : "B"},
        {id : "004", article : "Lampara",  quantity : 3, pedido : "E"}
    ]
}
...
const acumuladorDeLineasDeDetalle = lineasDeDetalle.reduce((acumulador, item)=>{
    return `${acumulador}
    * ${item.article} - ${item.quantity} - Pedido ${item.pedido}`
}, ``)
